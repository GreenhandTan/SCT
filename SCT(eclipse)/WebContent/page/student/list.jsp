...
<html>
		...
		<script type="text/javascript">
			$(function(){
				$('.remove').click(function(){
					if(confirm("请确认删除！")){
						window.location.href="<%=basePath %>student?method=delete&pageNo=0&stuNo="+$(this).attr("keyword");
					}
				})
			})
		</script>
	...
	<body>
		<!-- 组合条件查询 -->
		<form action="<%=basePath %>student?method=list&pageNo=${pageInfo.pageNo}" method="post">
		<div class="condition">
		...
		<table class="tablelist">
			...
			<tr>
				...
				<td>${student.stuNo}</td>
				<td>
					<button type="button" class="edit" onclick="window.location.href='<%=basePath %>student?method=edit&id=${student.stuNo}'">
						<i class="fa fa-edit"></i>
						修改
					</button>
					<button type="button" class="remove" keyword="${student.stuNo}">
